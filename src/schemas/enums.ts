...
export const OtpPurposeEnum = z.enum(["setPassword", "resetPassword", "verifyEmail", "changeEmail"]);
...
export const PostSearchByEnum = z.enum(["id", "title", "slug", "author", "category"]);
export const PostSortByEnum = z.enum(["publishedAt", "views", "title", "author", "category", "status"]);
