import { PrismaClient, type User, type Media, type Category, type Tag } from "@generated/prisma";
...
export async function seedUsers(prisma: PrismaClient) {
    ...
    return { admin, editor, author, authors: [author, ...authors] };
}
    ...
    const posts = [
        {
            ...
            excerpt: "Learn the fundamentals of medical billing and how it impacts healthcare revenue cycles.",
            content: `
      ...
      `,
            ...
            metaDescription: "Comprehensive guide to medical billing fundamentals for healthcare professionals and practice managers.",
        ...
        },
        {
            ...
            excerpt: "Stay compliant with the latest ICD-10 coding changes and implementation guidelines.",
            content: `
      ...
      `,
            ...
            metaDescription: "Complete overview of 2024 ICD-10 coding changes for medical billers and coders.",
        ...
        },
        {
            ...
            excerpt: "Ensure your practice meets all HIPAA requirements with this comprehensive checklist.",
            content: `
      ...
      `,
            ...
            metaDescription: "Step-by-step HIPAA compliance checklist for healthcare providers and medical practices.",
...
export async function createSampleContent(
    prisma: PrismaClient,
    users: { admin: User; editor: User; author: User },
    categories: Category[],
    tags: Tag[],
    mediaItems: Media[]
) {
    ...
    const samplePosts = [
        // Admin posts
        {
            ...
            excerpt: "Learn how to optimize your revenue cycle for maximum efficiency and profitability.",
        ...
        // Editor posts
        {
            ...
            excerpt: "Comparison of top medical billing software solutions for your practice.",
        ...
        },
        {
            ...
            excerpt: "Essential tips for billing Medicare Advantage plans effectively.",
        ...
        // Author posts
        {
            ...
            excerpt: "Learn about frequent billing mistakes and prevention strategies.",
