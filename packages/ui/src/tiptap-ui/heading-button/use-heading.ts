...
// --- Icons ---
import { HeadingOneIcon } from "@workspace/ui/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@workspace/ui/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@workspace/ui/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@workspace/ui/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@workspace/ui/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@workspace/ui/tiptap-icons/heading-six-icon";
