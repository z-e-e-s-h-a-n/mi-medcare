  ...
  return (
    <section className={cn("relative overflow-hidden py-24", className)}>
      <SectionHeader
        ...
        description="Our commitment to excellence reflected in real results"
        className="space-y-2"
      />

      <div className="section-wrapper">
        {/* Metrics Grid */}
        <div className="section-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
