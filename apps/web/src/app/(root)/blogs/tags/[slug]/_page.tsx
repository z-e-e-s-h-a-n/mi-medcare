...
export const TagDetailsClient = ({ tag }: { tag: TagResponse }) => {
  ...
  return (
    <>
      {/* Tag Header */}
      <section className="section-wrapper section-container py-12 md:py-16 bg-linear-to-r from-primary/10 to-primary/5">
        {/* Breadcrumb */}
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              ...
              {posts.length > 0 && (
                <>
                  ...
                  <Badge variant="outline" className="gap-1">
                    <Clock className="h-3 w-3" />~{averageReadTime} min avg read
                  </Badge>
                </>
              )}
            </div>
