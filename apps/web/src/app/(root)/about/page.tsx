        ...
        <div className="section-container">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.2fr_.8fr]">
            <div className="space-y-5 text-muted-foreground">
              <p>
                MI MedCare is a top-rated medical billing partner that
                specializes in solving revenue cycle challenges for practices
                across the United States. Our teams of 1,100+ certified billers
                and coders work behind the scenes to ensure claims are clean,
                compliant, and paid faster than industry averages. We adapt to
                your existing EMR, scheduling, and collections workflows so the
                transition is seamless and the revenue impact is immediate.
              </p>
              <p>
                ...
                and measurable improvements so you can reinvest time into
                patient care.
              </p>
            </div>
